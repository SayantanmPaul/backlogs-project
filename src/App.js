    ...
    <>
      <div className="App">
        <Parallax pages={3} style={{ top: '0', left: '0' }} class="animation">
          ...
          <ParallaxLayer offset={0} speed={0.3}>
            <div className="mountain_1 bg-cover animation_layer parallax ">
              {' '}
            </div>
          </ParallaxLayer>

          <ParallaxLayer offset={0} speed={0.4}>
            <div className="mountain_2 bg-cover animation_layer parallax">
              {' '}
            </div>
          </ParallaxLayer>
          ...
          <ParallaxLayer offset={0} speed={0.35}>
            <div className="traveller bg-cover animation_layer parallaxer">
              {' '}
            </div>
          </ParallaxLayer>
          ...
          <ParallaxLayer offset={1} speed={0.25}>
            <div className="flex justify-center">
              <div className="max-w-7xl flex-1">
                <div className="flex flex-col gap-3 mx-[5%] md:gap-6   ">
                  <Postcard />
                  <Postcard />
                  <Postcard />
                </div>
